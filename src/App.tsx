...
function App() {
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-between md:justify-center md:flex-row ">
      <div className="w-full md:w-1/2 flex flex-col md:flex-row h-full md:h-1/2 items-center md:rounded-xl md:shadow-2xl">
        <div className="h-2/5 md:h-full border flex flex-col items-center justify-around  w-full md:w-1/2 rounded-b-2xl  md:rounded-2xl bg-gradient-to-b from-slateBlue to-royalBlue py-4 ">
        ...
        <div className="h-3/5 flex flex-col gap-2 justify-around items-start md:items-center w-11/12 md:w-1/2 md:h-2/5 pl-8 md:px-4  ">
          ...
          <button className=" px-4 bg-darkGrayBlue text-white py-3 rounded-full w-11/12 md:w-full hover:bg-gradient-to-b md:from-slateBlue md:to-royalBlue mt-4">
            Continue
          </button>
        </div>
      </div>
